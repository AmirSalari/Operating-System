...
main(void)
{
   ...
   3:	83 e4 f0             	and    $0xfffffff0,%esp
    Gsanity();
   6:	e8 45 00 00 00       	call   50 <Gsanity>
    exit();
...
print_sth()
{
  ...
  20:	e8 1d 03 00 00       	call   342 <getpid>
  25:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
...
print_sth()
{
  ...
  47:	75 d7                	jne    20 <print_sth+0x10>
        printf(1, "process %d is printing for the %d time.\n", getpid(), i);
    }

}
  49:	83 c4 14             	add    $0x14,%esp
  4c:	5b                   	pop    %ebx
  4d:	5d                   	pop    %ebp
  4e:	c3                   	ret    
  4f:	90                   	nop
...
Gsanity(void)
{
  ...
  56:	e8 e7 02 00 00       	call   342 <getpid>
  5b:	c7 44 24 04 b4 07 00 	movl   $0x7b4,0x4(%esp)
  62:	00 
  ...
  7a:	e8 d3 02 00 00       	call   352 <sleep>
    pid = fork();
  7f:	e8 36 02 00 00       	call   2ba <fork>
    if(pid == 0){
  84:	85 c0                	test   %eax,%eax
  86:	74 06                	je     8e <Gsanity+0x3e>
    }
  ...
  88:	c9                   	leave  
    ...
    print_sth();
  89:	e9 82 ff ff ff       	jmp    10 <print_sth>
  8e:	66 90                	xchg   %ax,%ax
    ...
    if(pid == 0){
        print_sth();
  90:	e8 7b ff ff ff       	call   10 <print_sth>
        exit();
  95:	e8 28 02 00 00       	call   2c2 <exit>
  9a:	66 90                	xchg   %ax,%ax
  9c:	66 90                	xchg   %ax,%ax
  9e:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 657:	89 10                	mov    %edx,(%eax)
  freep = p;
 659:	a3 8c 0a 00 00       	mov    %eax,0xa8c
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 1d 8c 0a 00 00    	mov    0xa8c,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 6e9:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 6eb:	3b 15 8c 0a 00 00    	cmp    0xa8c,%edx
...
morecore(uint nu)
{
 ...
 71d:	e8 ee fe ff ff       	call   610 <free>
  return freep;
 722:	8b 15 8c 0a 00 00    	mov    0xa8c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 75c:	eb e9                	jmp    747 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 75e:	c7 05 8c 0a 00 00 90 	movl   $0xa90,0xa8c
 765:	0a 00 00 
    base.s.size = 0;
 768:	ba 90 0a 00 00       	mov    $0xa90,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 76d:	c7 05 90 0a 00 00 90 	movl   $0xa90,0xa90
 774:	0a 00 00 
    base.s.size = 0;
